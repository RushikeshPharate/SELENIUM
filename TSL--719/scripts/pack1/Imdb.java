...
public class Imdb {
	...
	public Object[][] createData1() {
		Object[][] retObjArr = getTableArray("test\\resources\\data\\Movie.xls",
				"Movies", "MovieTestData1");
		System.out.println("*****************  2 *************************");
		return (retObjArr);
	}

	@Test(dataProvider = "Cycle1")
	public void testDataProviderExample(String MovieName, String DirectorName, String MoviePlot, String ActorName)
			throws Exception {
		...
		driver.findElement(By.id("navbar-query")).sendKeys(MovieName);
		driver.findElement(By.id("navbar-submit-button")).click();
		
		driver.findElement(By.xpath("//*[@id='main']/div/div[2]/table/tbody/tr[1]/td[2]/a")).click();
		System.out.println("Actual : "+driver.findElement(By.xpath("//*[@id='title-overview-widget']/div[3]/div[1]/div[2]/a")).getText());
		System.out.println("Expected : "+DirectorName);
		Assert.assertEquals(driver.findElement(By.xpath("//*[@id='title-overview-widget']/div[3]/div[1]/div[2]/a")).getText(), DirectorName);
