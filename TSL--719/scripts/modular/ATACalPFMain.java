...
public class ATACalPFMain {
	...
	public void testDataProviderExample(String Operation, String Num1,
		...
		ATACalPF pageFactory = new ATACalPF(driver);

		String res1 = "null";

		switch (Operation.toUpperCase()) {
		case "ADD":
			res1 = pageFactory.add(Num1, Num2);
			System.out.println("Addition:" + res1);
			break;
		case "MUL":
			res1 = pageFactory.multiply(Num1, Num2);
			System.out.println("Multiplication:" + res1);
			break;
		case "SQR":
			res1 = pageFactory.sqr(Num1, Num2);
			System.out.println("SQR:" + res1);
			break;
		case "COMP":
			System.out.println("COMP:" + pageFactory.comp(Num1, Num2));
			res1 = pageFactory.comp(Num1, Num2);
			break;
		case "SQRSUB":
			res1 = pageFactory.sqrSub(Num1, Num2);
			System.out.println("SQRSUB:" + res1);
			break;
		case "EUCLID(+)":
			res1 = pageFactory.euclidPlus(Num1, Num2);
			System.out.println("EUCLIDPLUS:" + res1);
			break;
		case "EUCLID(-)":
			res1 = pageFactory.euclidMinus(Num1, Num2);
